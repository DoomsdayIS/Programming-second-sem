...
void my_sol::reverse_forward_0_1_box(Cube &cube, char color_1, char color_2) {
    if (cube.get_forward_matrix()[0][1] == color_1 && cube.get_up_matrix()[2][1] == color_2) {
        cube.enter_commands_for_cube({'f', 'U', 'r', 'u'});
    }
}

void my_sol::find_side_box(Cube &cube, char color_1, char color_2) {
    if (cube.get_forward_matrix()[0][1] == color_1 && cube.get_up_matrix()[2][1] == color_2) {
        cube.enter_commands_for_cube({'f', 'U', 'r', 'u'});
        return;
    }
...
void my_sol::solve_corner(Cube &cube, char color_1, char color_2, char color_3) {
    for (int i = 0; i < 3; ++i) {
...
void my_sol::solve_white_line(Cube &cube) {
...
void my_sol::solve_white_corner(Cube &cube) {
...
void my_sol::find_accord_up_and_side(Cube &cube) {
    for (int i = 0; i < 4; ++i) {
        for (int j = 0; j < 4; ++j) {
...
bool my_sol::is_correct_place_to_corner(Cube &cube, char color_1, char color_2, char color_3) {
...
void my_sol::step_5(Cube &cube) {
    ...
    if (cube.get_forward_matrix()[0][1] == cube.get_forward_matrix()[1][1] &&
        ...
        if (!(cube.get_forward_matrix()[0][1] == cube.get_forward_matrix()[1][1] &&
              ...
              cube.get_left_matrix()[0][1] == cube.get_left_matrix()[1][1] &&
              cube.get_back_matrix()[0][1] == cube.get_back_matrix()[1][1])) {
            throw my_exception("Incorrect cube!");
        }
    }
}

void my_sol::step_6(Cube &cube) {
...
void my_sol::step_7(Cube &cube) {
    ...
    if (!cube.check_status()) {
        throw my_exception("Cube wasn't solved");
    }
}